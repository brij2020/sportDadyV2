...
const LiveCommentry = () => {
   ...
   <div id="fullScoreContent" class={`mcTabContent ${!isCommentry ? 'current' : ''}`} ng-class="{'current' : scorecardType != 'international' || internationalPulseMatches == 1}">
      ...
      <div id="leftPanel" class="col s12 m12 l8">
         ...
         <div class="battingCardMC" data-active="">
            <div class="mcRowHead">
               ...
               <div class="mcGrid_6 alignC">
                  ...
                  <div class="mcGrid_2 ng-scope" ng-if="!internationalArchive"> <span class="select-play-bt viewPlayerDet hide-on-small-only">More </span> </div>
            ...
            <div class="mcRowData playerWagonBatting ng-scope" ng-repeat="battingCardResult in battingCard | filter:notEmptyOrNull">
               <div class="mcRowData-Inner">
                  <div class="mcGrid_6 sc-first-row">
                     ...
                     <div class="sc-pnam">
                        <span class="playerName vclickable ng-binding" ng-click="playVideo(battingCardResult.PlayerID,'all')">
                           Matthew Kuhnemann  {/* ngIf: !checkMatchEnd(matchSummary.MatchID) && matchSummary.CurrentStrikerID == battingCardResult.PlayerID */}
                  ...
                  <div class="mcGrid_6 alignC plyData">
                     <div class="mcGrid_2 icon-play btRuns vclickable ng-binding novideo" ng-class="{novideo : battingCardResult.Runs=='0'}" ng-click="playVideo(battingCardResult.PlayerID,'runs')" ng-bind="battingCardResult.Runs">0</div>
                     <div class="mcGrid_2 icon-play vclickable ng-binding" ng-class="{novideo : battingCardResult.Balls=='0'}" ng-click="playVideo(battingCardResult.PlayerID,'all')" ng-bind="battingCardResult.Balls">18</div>
                     <div class="mcGrid_2 hide-on-small-only ng-binding" ng-bind="battingCardResult.StrikeRate">0.00</div>
                     <div class="mcGrid_2 icon-play vclickable ng-binding pvclickable novideo" ng-class="{pvclickable : checkVideoclickables('four'),novideo : battingCardResult.Fours=='0','mcGrid_1' : scorecardType == 'international' &amp;&amp; inningsMediaList.length > 0}" ng-click="playVideo(battingCardResult.PlayerID,'four')" ng-bind="battingCardResult.Fours">0</div>
                     <div class="mcGrid_2 icon-play vclickable ng-binding pvclickable novideo" ng-class="{pvclickable : checkVideoclickables('six'),novideo : battingCardResult.Sixes=='0','mcGrid_1' : scorecardType == 'international' &amp;&amp; inningsMediaList.length > 0}" ng-click="playVideo(battingCardResult.PlayerID,'six')" ng-bind="battingCardResult.Sixes">0</div>
            ...
            <div class="mcRowData playerWagonBatting ng-scope" ng-repeat="battingCardResult in battingCard | filter:notEmptyOrNull">
               <div class="mcRowData-Inner">
                  <div class="mcGrid_6 sc-first-row">
                     ...
                     <div class="sc-pnam">
                        <span class="playerName vclickable ng-binding" ng-click="playVideo(battingCardResult.PlayerID,'all')">
                           Travis Head  {/* ngIf: !checkMatchEnd(matchSummary.MatchID) && matchSummary.CurrentStrikerID == battingCardResult.PlayerID */} 
                        </span>
                        <span class="dismissalSmall vclickable ng-binding pvclickable b__notout" ng-class="{pvclickable : checkVideoclickables('wicket'),b__notout : battingCardResult.OutDesc == 'not out'}" ng-click="playVideo(battingCardResult.PlayerID,'wicket')" ng-bind="battingCardResult.OutDesc">not out</span> 
                     </div>
                  </div>
                  <div class="mcGrid_6 alignC plyData">
                     <div class="mcGrid_2 icon-play btRuns vclickable ng-binding" ng-class="{novideo : battingCardResult.Runs=='0'}" ng-click="playVideo(battingCardResult.PlayerID,'runs')" ng-bind="battingCardResult.Runs">3</div>
                     <div class="mcGrid_2 icon-play vclickable ng-binding" ng-class="{novideo : battingCardResult.Balls=='0'}" ng-click="playVideo(battingCardResult.PlayerID,'all')" ng-bind="battingCardResult.Balls">18</div>
                     <div class="mcGrid_2 hide-on-small-only ng-binding" ng-bind="battingCardResult.StrikeRate">16.67</div>
                     <div class="mcGrid_2 icon-play vclickable ng-binding pvclickable novideo" ng-class="{pvclickable : checkVideoclickables('four'),novideo : battingCardResult.Fours=='0','mcGrid_1' : scorecardType == 'international' &amp;&amp; inningsMediaList.length > 0}" ng-click="playVideo(battingCardResult.PlayerID,'four')" ng-bind="battingCardResult.Fours">0</div>
                     <div class="mcGrid_2 icon-play vclickable ng-binding pvclickable novideo" ng-class="{pvclickable : checkVideoclickables('six'),novideo : battingCardResult.Sixes=='0','mcGrid_1' : scorecardType == 'international' &amp;&amp; inningsMediaList.length > 0}" ng-click="playVideo(battingCardResult.PlayerID,'six')" ng-bind="battingCardResult.Sixes">0</div>
                     <div class="mcGrid_2 playerpopup  ng-hide" ng-show="battingCardResult.wicketVideo != undefined &amp;&amp; battingCardResult.wicketVideo.mediaId != undefined &amp;&amp; battingCardResult.wicketVideo.mediaId != '' &amp;&amp; scorecardType == 'international' &amp;&amp; battingCardResult.OutDesc != '' &amp;&amp; battingCardResult.OutDesc != 'not out' &amp;&amp; inningsMediaList.length > 0" data-mediaid="" data-videotitle="" data-description="" data-videoview="" data-videoid=""> <img src="https://www.bcci.tv/assets/images/Play.png" style={{ "width":"20px",height:"20px",display:"inline-block",cursor:"pointer"}} alt="" /> </div>
                     <div class="mcGrid_2  ng-hide" ng-show="scorecardType == 'international' &amp;&amp;( battingCardResult.OutDesc == '' || battingCardResult.OutDesc == 'not out' || battingCardResult.wicketVideo.mediaId == '' || battingCardResult.wicketVideo.mediaId == undefined) &amp;&amp; inningsMediaList.length > 0"></div>
            ...
            <div class="mcExtras">
               <div class="mcGrid_6">
                  <span class="ng-binding">Extras </span> 
                  <span>
               ...
               <div class="mcGrid_6 alignC vclickable" ng-click="playInnExtras('all',battingCard[0].InningsNo)">
                  <div class="mcGrid_2 icon-play extRuns alignC ng-binding" ng-bind="extras.TotalExtras">0</div>
               </div>
            </div>
            <div class="mcTotal">
         ...
         <div class="mcNotBat ng-scope" ng-if="didNotBatList.length!=0">
                  ...
                  <div class="mcGrid_6 sc-first-row vclickable" ng-click="playVideo(bowlingCardResult.PlayerID,'bowlerall')">
                     ...
                     <div class="sc-pnam">
                        <span class="playerName ng-binding">
                           Ravichandran Ashwin {/* ngIf: !checkMatchEnd(matchSummary.MatchID) && matchSummary.CurrentBowlerID == bowlingCardResult.PlayerID */} 
                        </span>
                     </div>
                  </div>
                  <div class="mcGrid_6 alignC plyData">
                     <div class="mcGrid_2 icon-play btRuns vclickable ng-binding" ng-click="playVideo(bowlingCardResult.PlayerID,'overs')" ng-class="{novideo : bowlingCardResult.Overs == '0'}" ng-bind="bowlingCardResult.Overs">3</div>
                     {/* ngIf: matchSummary.MatchType != 'Twenty20 Match' */}
                     <div class="mcGrid_2 icon-play vclickable hide-on-small-only ng-binding ng-scope" ng-class="{novideo : bowlingCardResult.Maidens == '0'}" ng-if="matchSummary.MatchType != 'Twenty20 Match'" ng-click="playVideo(bowlingCardResult.PlayerID,'maiden')" ng-bind="bowlingCardResult.Maidens">2</div>
                     {/* end ngIf: matchSummary.MatchType != 'Twenty20 Match' */} 
                     ...
                     {/* ngIf: matchSummary.MatchType == 'Twenty20 Match' */} 
                     <div class="mcGrid_2 hide-on-small-only ng-binding" ng-bind="bowlingCardResult.Economy">0.33</div>
            ...
            <div class="mcRowData playerWagonBowling ng-scope" ng-repeat="bowlingCardResult in bowlingCard" ng-if="bowlingCardResult.PlayerName != '' &amp;&amp; bowlingCardResult.PlayerName != '0'">
               <div class="mcRowData-Inner">
                  <div class="mcGrid_6 sc-first-row vclickable" ng-click="playVideo(bowlingCardResult.PlayerID,'bowlerall')">
                     ...
                     <div class="sc-pnam">
                        <span class="playerName ng-binding">
                           Ravindra Jadeja {/* ngIf: !checkMatchEnd(matchSummary.MatchID) && matchSummary.CurrentBowlerID == bowlingCardResult.PlayerID */} 
                        </span>
                     </div>
                  </div>
                  <div class="mcGrid_6 alignC plyData">
                     <div class="mcGrid_2 icon-play btRuns vclickable ng-binding" ng-click="playVideo(bowlingCardResult.PlayerID,'overs')" ng-class="{novideo : bowlingCardResult.Overs == '0'}" ng-bind="bowlingCardResult.Overs">2</div>
                     {/* ngIf: matchSummary.MatchType != 'Twenty20 Match' */}
                     <div class="mcGrid_2 icon-play vclickable hide-on-small-only ng-binding ng-scope" ng-class="{novideo : bowlingCardResult.Maidens == '0'}" ng-if="matchSummary.MatchType != 'Twenty20 Match'" ng-click="playVideo(bowlingCardResult.PlayerID,'maiden')" ng-bind="bowlingCardResult.Maidens">1</div>
                     {/* end ngIf: matchSummary.MatchType != 'Twenty20 Match' */} 
                     <div class="mcGrid_2 icon-play vclickable ng-binding" ng-class="{novideo : bowlingCardResult.Runs == '0'}" ng-click="playVideo(bowlingCardResult.PlayerID,'runsconceded')" ng-bind="bowlingCardResult.Runs">1</div>
                     <div class="mcGrid_2 icon-play vclickable ng-binding pvclickable novideo" ng-click="playVideo(bowlingCardResult.PlayerID,'wicketstaken')" ng-class="{pvclickable : checkVideoclickables('wicket'),novideo : bowlingCardResult.Wickets == '0'}" ng-bind="bowlingCardResult.Wickets">0</div>
                     {/* ngIf: matchSummary.MatchType == 'Twenty20 Match' */} 
         ...
         <div class="partnerChart">
            ...
            <ul class="partnerContent">
               ...
               <li ng-repeat="data in PartnerShipRuns" class="ng-scope">
                  <div class="partners-name vclickable" ng-click="playPartnership('striker',data.StrikerID,data.NonStrikerID)"> <span class="prName ng-binding">Matthew Kuhnemann </span> <span class="prScore ng-binding">0 <i class="ng-binding">(18)</i> </span> </div>
                  <div class="parters-chart">
                     <div class="prTot vclickable" ng-click="playPartnership('all',data.StrikerID,data.NonStrikerID)">Partnership - <span class="ng-binding">3* <i class="ng-binding">(36)</i> </span> </div>
                     <div class="bar-wrap">
                  ...
                  <div class="partners-name vclickable" ng-click="playPartnership('nonstriker',data.StrikerID,data.NonStrikerID)"> <span class="prName ng-binding">Travis Head </span> <span class="prScore ng-binding">3 <i class="ng-binding">(18)</i> </span> </div>
               </li>
   ...
   <div id="commentPage" class={`mcTabContent ${isCommentry ? 'current' : ''}`} ng-class="{'current' : scorecardType == 'international' &amp;&amp; internationalPulseMatches != 1}">
      ...
      <div id="miniscoreCard" class="ng-scope" ng-if="IsMatchEnd != 1 &amp;&amp; scorecardType == 'international' &amp;&amp; internationalPulseMatches != 1 &amp;&amp; (matchInn == matchSummary.CurrentInnings || matchInn == '')">
         ...
         <div class="battingCardMC battingCardMC_mini" data-active="">
            ...
            <div class="mcRowData playerWagonBatting stricker">
               <div class="mcRowData-Inner">
                  <div class="mcGrid_7 sc-first-row">
                     {/* ngIf: isNotNull(CurrentStrikerData.PlayerImage) */}<img class="ng-scope active" ng-class="{'active' : scorecardType == 'international' &amp;&amp; !internationalArchive}" ng-if="isNotNull(CurrentStrikerData.PlayerImage)" ng-src="https://scores.bcci.tv/matchcentre/playerimages/slbPvyM5zi16766163481050.png" alt="" onerror="this.src = basePath+'images/player-thumb.jpg';" title="Matthew Kuhnemann " src="https://scores.bcci.tv/matchcentre/playerimages/slbPvyM5zi16766163481050.png" />{/* end ngIf: isNotNull(CurrentStrikerData.PlayerImage) */} {/* ngIf: !isNotNull(CurrentStrikerData.PlayerImage) */} 
                     <div class="sc-pnam">
                        <span class="playerName vclickable ng-binding" ng-click="playVideo(CurrentStrikerData.PlayerID,'all')">Matthew Kuhnemann  </span> {/* ngIf: matchSummary.CurrentStrikerID == CurrentStrikerData.PlayerID */}
                        <icon class="strikerIcon ng-scope" ng-if="matchSummary.CurrentStrikerID == CurrentStrikerData.PlayerID"></icon>
                        {/* end ngIf: matchSummary.CurrentStrikerID == CurrentStrikerData.PlayerID */} <span class="dismissalSmall vclickable ng-binding pvclickable" ng-class="{pvclickable : checkVideoclickables('wicket')}" ng-click="playVideo(CurrentStrikerData.PlayerID,'wicket')" ng-bind="CurrentStrikerData.OutDesc">not out</span> 
                     </div>
                  </div>
                  <div class="mcGrid_5 alignC plyData">
                     <div class="mcGrid_3 icon-play btRuns vclickable ng-binding novideo" ng-class="{novideo : CurrentStrikerData.Runs=='0'}" ng-click="playVideo(CurrentStrikerData.PlayerID,'runs')" ng-bind="CurrentStrikerData.Runs">0</div>
                     <div class="mcGrid_3 icon-play vclickable ng-binding" ng-class="{novideo : CurrentStrikerData.Balls=='0'}" ng-click="playVideo(CurrentStrikerData.PlayerID,'all')" ng-bind="CurrentStrikerData.Balls">18</div>
                     <div class="mcGrid_3 icon-play vclickable ng-binding pvclickable novideo" ng-class="{pvclickable : checkVideoclickables('four'),novideo : CurrentStrikerData.Fours=='0'}" ng-click="playVideo(CurrentStrikerData.PlayerID,'four')" ng-bind="CurrentStrikerData.Fours">0</div>
                     <div class="mcGrid_3 icon-play vclickable ng-binding pvclickable novideo" ng-class="{pvclickable : checkVideoclickables('six'),novideo : CurrentStrikerData.Sixes=='0'}" ng-click="playVideo(CurrentStrikerData.PlayerID,'six')" ng-bind="CurrentStrikerData.Sixes">0</div>
                     {/*<div class="mcGrid_2" ng-bind="CurrentStrikerData.StrikeRate"></div> */} 
                  </div>
               </div>
               {/* END .mcRowData */} 
            </div>
            <div class="mcRowData playerWagonBatting stricker">
               <div class="mcRowData-Inner">
                  <div class="mcGrid_7 sc-first-row">
                     {/* ngIf: isNotNull(CurrentNonStrikerData.PlayerImage) */}<img class="ng-scope active" ng-class="{'active' : scorecardType == 'international' &amp;&amp; !internationalArchive}" ng-if="isNotNull(CurrentNonStrikerData.PlayerImage)" ng-src="https://scores.bcci.tv/matchcentre/playerimages/yOqhwq86Ir167585734037.png" alt="" onerror="this.src = basePath+'images/player-thumb.jpg';" title="2018-100mb00000000037-4e250de6f88a11" src="https://scores.bcci.tv/matchcentre/playerimages/yOqhwq86Ir167585734037.png" />{/* end ngIf: isNotNull(CurrentNonStrikerData.PlayerImage) */} {/* ngIf: !isNotNull(CurrentNonStrikerData.PlayerImage) */} 
                     <div class="sc-pnam"> <span class="playerName vclickable ng-binding" ng-click="playVideo(CurrentNonStrikerData.PlayerID,'all')">Travis Head  </span> <span class="dismissalSmall vclickable ng-binding pvclickable" ng-class="{pvclickable : checkVideoclickables('wicket')}" ng-click="playVideo(CurrentNonStrikerData.PlayerID,'wicket')" ng-bind="CurrentNonStrikerData.OutDesc">not out</span> </div>
                  </div>
                  <div class="mcGrid_5 alignC plyData">
                     <div class="mcGrid_3 icon-play btRuns vclickable ng-binding" ng-class="{novideo : CurrentNonStrikerData.Runs=='0'}" ng-click="playVideo(CurrentNonStrikerData.PlayerID,'runs')" ng-bind="CurrentNonStrikerData.Runs">3</div>
                     <div class="mcGrid_3 icon-play vclickable ng-binding" ng-class="{novideo : CurrentNonStrikerData.Balls=='0'}" ng-click="playVideo(CurrentNonStrikerData.PlayerID,'all')" ng-bind="CurrentNonStrikerData.Balls">18</div>
                     <div class="mcGrid_3 icon-play vclickable ng-binding pvclickable novideo" ng-class="{pvclickable : checkVideoclickables('four'),novideo : CurrentNonStrikerData.Fours=='0'}" ng-click="playVideo(CurrentNonStrikerData.PlayerID,'four')" ng-bind="CurrentNonStrikerData.Fours">0</div>
                     <div class="mcGrid_3 icon-play vclickable ng-binding pvclickable novideo" ng-class="{pvclickable : checkVideoclickables('six'),novideo : CurrentNonStrikerData.Sixes=='0'}" ng-click="playVideo(CurrentNonStrikerData.PlayerID,'six')" ng-bind="CurrentNonStrikerData.Sixes">0</div>
            ...
            <div class="mcRowData playerWagonBowling Bowler ng-scope" ng-if="CurrentBowlerData.PlayerName != '' &amp;&amp; CurrentBowlerData.PlayerName != '0'">
               <div class="mcRowData-Inner">
                  <div class="mcGrid_6 sc-first-row vclickable" ng-click="playVideo(CurrentBowlerData.PlayerID,'bowlerall')">
                     ...
                     <div class="sc-pnam">
                        <span class="playerName ng-binding">Mohammad Shami </span> {/* ngIf: matchSummary.CurrentBowlerID == CurrentBowlerData.PlayerID */}
                  ...
                  <div class="mcGrid_6 alignC plyData">
                     <div class="mcGrid_2 icon-play btRuns vclickable ng-binding" ng-click="playVideo(CurrentBowlerData.PlayerID,'overs')" ng-class="{novideo : CurrentBowlerData.Overs == '0'}" ng-bind="CurrentBowlerData.Overs">1</div>
                     {/* ngIf: matchSummary.MatchType != 'Twenty20 Match' */}
                     ...
                     {/* end ngIf: matchSummary.MatchType != 'Twenty20 Match' */} 
                     <div class="mcGrid_2 icon-play vclickable ng-binding" ng-class="{novideo : CurrentBowlerData.Runs == '0'}" ng-click="playVideo(CurrentBowlerData.PlayerID,'runsconceded')" ng-bind="CurrentBowlerData.Runs">1</div>
                     <div class="mcGrid_2 icon-play vclickable ng-binding pvclickable novideo" ng-click="playVideo(CurrentBowlerData.PlayerID,'wicketstaken')" ng-class="{pvclickable : checkVideoclickables('wicket'),novideo : CurrentBowlerData.Wickets == '0'}" ng-bind="CurrentBowlerData.Wickets">0</div>
                     {/* ngIf: matchSummary.MatchType == 'Twenty20 Match' */} 
                     <div class="mcGrid_2 hide-on-small-only ng-binding" ng-bind="CurrentBowlerData.Economy">1</div>
                  </div>
               </div>
            </div>
      ...
      <div id="cmdBlockSmipl" class="col s12 m12 l8  l12" ng-class="{'l12' : matchNotes == undefined || matchNotes.length == 0 || matchNotes == '','widget':matchNotes.length > 0 &amp;&amp; windowWdt > 480}">
         ...
         <div class="prepostMatchCommentry ng-scope" ng-if="((postMatchCommentary != undefined &amp;&amp; postMatchCommentary !='') || (matchSummary.PostMatchCommentary != undefined &amp;&amp; matchSummary.PostMatchCommentary !='')) &amp;&amp; (matchInn == matchSummary.CurrentInnings || matchInn == '')">
            <p class="ppCmd">
