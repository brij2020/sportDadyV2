...
const PhotoStory = (props) => {
    ...
    // }
    return (
        <div className='tp-section' style={{ paddingTop:"3%"}}>
        <main role="main">
                    ...
                    <div class="daily-stories__container">
                        {
                            slides && slides.map(({ url, ids, timeOut, contentType } = { url: '', ids: '90K', timeOut: "0", contentType: "" }, i) => {
                                ...
                                return (
                                    <div class={`pgt-slide ${i === activeIndex ? 'v-slide active' : 'hide-slide'}`} data-timeout={`${timeOut}`} key={ids} >
                                        {
                                            contentType !== 'video' ? (
                                        ...
                                        <div class="pgt-gradient"><h3>Nikki Tamboli In Embellished Outfits</h3></div>
                                    </div>
